...
{{- printf "%s-keycloak" (include "application.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-keycloak" (include "application.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-database" (include "application.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-database" (include "application.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
